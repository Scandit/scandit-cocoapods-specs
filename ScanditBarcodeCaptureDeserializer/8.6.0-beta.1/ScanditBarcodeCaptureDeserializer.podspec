Pod::Spec.new do |s|
  ...
  s.platform            = :ios, '15.0'
  s.source              = { :http => 'https://ssl.scandit.com/sdk/download/scandit-datacapture-ios-barcode-deserializer-8.6.0-beta.1-xcframework.zip' }
  s.requires_arc        = true
  s.module_name         = 'ScanditBarcodeCaptureDeserializer'
  s.vendored_frameworks = 'ScanditBarcodeCaptureDeserializer.xcframework'
  s.dependency 'ScanditBarcodeCapture', '= 8.6.0-beta.1'

Pod::Spec.new do |s|
  ...
  s.platform            = :ios, '15.0'
  s.source              = { :http => 'https://ssl.scandit.com/sdk/download/scandit-datacapture-ios-parser-deserializer-8.5.0-beta.1-xcframework.zip' }
  s.requires_arc        = true
  s.module_name         = 'ScanditParserDeserializer'
  s.vendored_frameworks = 'ScanditParserDeserializer.xcframework'
  s.dependency 'ScanditParser', '= 8.5.0-beta.1'

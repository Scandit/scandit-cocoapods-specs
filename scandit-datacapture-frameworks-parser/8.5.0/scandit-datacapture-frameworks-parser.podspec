Pod::Spec.new do |s|
    ...
    s.source                  = { :git => 'https://github.com/Scandit/scandit-datacapture-frameworks-parser.git', :tag => '8.5.0' }
    s.swift_version           = '5.7'
    ...
    s.dependency 'ScanditParser', '= 8.5.0'
    s.dependency 'ScanditParserDeserializer', '= 8.5.0'
end

Pod::Spec.new do |s|
    ...
    s.source                  = { :git => 'https://github.com/Scandit/scandit-datacapture-frameworks-parser.git', :tag => '8.5.1' }
    s.swift_version           = '5.7'
    ...
    s.dependency 'scandit-datacapture-frameworks-core', '= 8.5.1'
    s.dependency 'ScanditParser', '= 8.5.1'
    s.dependency 'ScanditParserDeserializer', '= 8.5.1'
end

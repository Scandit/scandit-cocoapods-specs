Pod::Spec.new do |s|
    ...
    s.source                  = { :git => 'https://github.com/Scandit/scandit-datacapture-frameworks-label.git', :tag => '8.5.2' }
    s.swift_version           = '5.7'
    ...
    s.dependency 'ScanditLabelCaptureDeserializer', '= 8.5.2'
    s.dependency 'scandit-datacapture-frameworks-barcode', '= 8.5.2'
end

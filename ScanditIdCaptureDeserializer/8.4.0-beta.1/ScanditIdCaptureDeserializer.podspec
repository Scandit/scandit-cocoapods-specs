Pod::Spec.new do |s|
  ...
  s.platform            = :ios, '15.0'
  s.source              = { :http => 'https://ssl.scandit.com/sdk/download/scandit-datacapture-ios-id-deserializer-8.4.0-beta.1-xcframework.zip' }
  s.requires_arc        = true
  s.module_name         = 'ScanditIdCaptureDeserializer'
  s.vendored_frameworks = 'ScanditIdCaptureDeserializer.xcframework'
  s.dependency 'ScanditIdCapture', '= 8.4.0-beta.1'

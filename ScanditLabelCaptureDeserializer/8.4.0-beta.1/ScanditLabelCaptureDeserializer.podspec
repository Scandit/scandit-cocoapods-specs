Pod::Spec.new do |s|
  ...
  s.platform            = :ios, '15.0'
  s.source              = { :http => 'https://ssl.scandit.com/sdk/download/scandit-datacapture-ios-label-deserializer-8.4.0-beta.1-xcframework.zip' }
  s.requires_arc        = true
  s.module_name         = 'ScanditLabelCaptureDeserializer'
  s.vendored_frameworks = 'ScanditLabelCaptureDeserializer.xcframework'
  s.dependency 'ScanditLabelCapture', '= 8.4.0-beta.1'
  s.dependency 'ScanditBarcodeCaptureDeserializer', '= 8.4.0-beta.1'
  s.dependency 'ScanditCaptureCoreDeserializer', '= 8.4.0-beta.1'
end

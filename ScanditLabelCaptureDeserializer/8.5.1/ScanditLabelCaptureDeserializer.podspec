Pod::Spec.new do |s|
  ...
  s.platform            = :ios, '15.0'
  s.source              = { :http => 'https://ssl.scandit.com/sdk/download/scandit-datacapture-ios-label-deserializer-8.5.1-xcframework.zip' }
  s.requires_arc        = true
  ...
  s.dependency 'ScanditBarcodeCaptureDeserializer', '= 8.5.1'

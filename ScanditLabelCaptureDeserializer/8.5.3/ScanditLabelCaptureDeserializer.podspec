Pod::Spec.new do |s|
  ...
  s.platform            = :ios, '15.0'
  s.source              = { :http => 'https://ssl.scandit.com/sdk/download/scandit-datacapture-ios-label-deserializer-8.5.3-xcframework.zip' }
  s.requires_arc        = true
  s.module_name         = 'ScanditLabelCaptureDeserializer'
  s.vendored_frameworks = 'ScanditLabelCaptureDeserializer.xcframework'
  s.dependency 'ScanditLabelCapture', '= 8.5.3'
  s.dependency 'ScanditBarcodeCaptureDeserializer', '= 8.5.3'
  s.dependency 'ScanditCaptureCoreDeserializer', '= 8.5.3'
end
